    ...
    body = {
        ...
        "properties": {
            ...
            "Category": {"select": {"options": [
                {"name": "드로잉·채색",       "color": "blue"},
                {"name": "연성·팬덤",         "color": "pink"},
                {"name": "실용 정보",         "color": "green"},
                {"name": "창작 도구·레퍼런스", "color": "yellow"},
                {"name": "굿즈·피규어",       "color": "purple"},
                {"name": "게임 공략",         "color": "red"},
                {"name": "기술·AI",          "color": "gray"},
                {"name": "커미션·작가",       "color": "orange"},
